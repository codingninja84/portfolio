...
export class LanguagesComponent implements OnInit {
  ...
  language: any = {
    ...
    "TypeScript":  { frameworks: ["Angular2", "Backbone", "React"],  about: "This is JavaScript without a lot of the looseness of JS. It uses ES6 type syntax and super fun to write in! This portfolio is actually built using Angular2, and some of the best web apps I have built are created using TypeScript"},
    "Swift":  { frameworks: ["Xcode", "Foundation", "Core-Motion", "Core-Data", "Auto-Layout"], about: "Objective-C, without the C. Apple's own words when they unveiled this Static Language. It's a blast to write in! X-code compiles as you type and the storyboard makes build Auto-Layouts a breeze! Mobile app development has never been so easy!"},
